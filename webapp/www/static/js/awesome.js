...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        template: '<ul class="uk-pagination">\
                ...
                <li v-if="page.has_previous"><a v-bind:onclick="gotoPage(page.page_index-1)" href="#0"><i class="uk-icon-angle-double-left"></i></a></li>\
                <li class="uk-active"><span v-text="page.page_index"></span></li>\
                <li v-if="! page.has_next" class="uk-disabled"><span><i class="uk-icon-angle-double-right"></i></span></li>\
                <li v-if="page.has_next"><a v-bind:onclick="gotoPage(page.page_index+1)" href="#0"><i class="uk-icon-angle-double-right"></i></a></li>\
            </ul> '
    });
}
